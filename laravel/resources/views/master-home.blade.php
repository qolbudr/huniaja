...
<body url="{{ URL::to('/') }}">
  <nav class="navbar navbar-home d-flex align-items-center text-white is-shadow">
    ...
    <div class="navbar-menu hide-mobile">
      <ul class="no-margin list-none d-flex align-items-center">
        ...
        @else
          ...
          <li>
            <a class="btn btn-primary no-margin px-4 py-2 text-white" href="{{ URL::to('owner/login') }}">Daftarkan Properti</a>
          </li>
        @endif
      </ul>
    </div>
