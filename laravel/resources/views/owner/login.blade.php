            ...
            <div class="auth-box row">
                ...
                <div class="col-lg-5 col-md-7 bg-white">
                    <div class="p-3">
                        ...
                        <p class="text-center">Masuk sebagai pemilik untuk mendaftarkan properti</p>
                        <form action="{{ URL::to('auth/owner/login') }}" method="post" class="mt-4">
                            @csrf
                            <div class="row">
                                <div class="col-lg-12">
                                ...
                                <div class="col-lg-12 text-center mt-5">
                                    Belum punya akun ? <a class="text-primary" href="{{ URL::to('owner/register') }}" class="text-danger">Daftar</a>
                                </div>
                            </div>
                        </form>
                    </div>
