...
<body url="{{ URL::to('/') }}">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        <li class="sidebar-item">
                            <a class="sidebar-link sidebar-link" href="{{ URL::to('admin/dashboard') }}">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="{{ URL::to('admin/facility') }}">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="{{ URL::to('admin/withdraw') }}">
                                <i data-feather="dollar-sign" class="feather-icon"></i>
                                <span class="hide-menu">Penarikan</span>
                            </a>
                        </li>
                        <li class="list-divider"></li>
                        <li class="sidebar-item" id="settingAccount" type="button" data-toggle="modal" data-target="#settingAccountDialog">
        ...
        <div class="modal fade" id="settingAccountDialog" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <form action="{{URL::to('adminUpdateCurrentCredential')}}" id="updateAccount" method="POST">
                      @csrf
    ...
    <script>
        let btnSetting = document.querySelector('#settingAccount')
        let formUpdate = document.querySelector('#updateAccount')
